# Graph Report - HungryMan  (2026-09-01)

## Corpus Check
- 159 files · ~28,423 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 819 nodes · 1298 edges · 60 communities (53 shown, 7 thin omitted)
...
### Community 3 - "Product"
Cohesion: 0.11
Nodes (16): Category, Product, IProductRepository, GetCatalogUseCase, BaseAPIRequest, BaseAPIResponse, HttpClient, MOCK_CATEGORIES (+8 more)
...
### Community 9 - "Shared.Models"
Cohesion: 0.18
Nodes (7): DateTime, BaseAPIRequest, int, PaginationRequest, IEnumerable, PaginationResponse, Shared.Models
...
Cohesion: 0.09
Nodes (23): App(), AppContent(), ProtectedRoute(), LoginRequest, LoginResponseDTO, JwtClaims, UserProfile, IAuthRepository (+15 more)
...
Cohesion: 0.18
Nodes (9): ActionResult, Task, LoginHandler, IConfiguration, LoginRequestDTO, LoginResponseDTO, HttpPost, IRequestHandler (+1 more)
...
Cohesion: 0.18
Nodes (10): 🏛️ 1. Architecture Philosophy & Design Methodology, 📁 2. Directory Structure, 🛠️ 3. Technology Stack & Technical Methods, 🔄 4. Data Flow & Layer Interaction, 💎 5. Design Patterns & Best Practices, ⚡ 6. Building & Running Locally, Clean Architecture & Technical Method Guide, Data Flow Sequence: Authentication & Fallback (+2 more)
...
Cohesion: 0.33
Nodes (5): AuthController, ILogger, ControllerBase, AuthenticationService.API.Controllers.v1, ISender

### Community 58 - "RolePermission"
Cohesion: 0.50
Nodes (4): IRolePermissionRepository, RolePermission, DateTime, RolePermissionRepository

### Community 59 - "BaseAPIResponse"
Cohesion: 0.50
Nodes (3): DateTime, List, BaseAPIResponse

## Knowledge Gaps
- **187 isolated node(s):** `net10.0`, `AspNetCore.HealthChecks.Uris (9.0.0)`, `Microsoft.AspNetCore.OpenApi (10.0.9)`, `Ocelot (24.1.0)`, `Serilog.AspNetCore (10.0.0)` (+182 more)
...
- **Why does `AuthenticationService.Infrastructure.DatabaseConfiguration` connect `AuthenticationService.Domain.Entities` to `.SavingChangesAsync`, `InitialCreate`, `DatabaseOptions.cs`, `AuthenticationServiceDbContextTests.cs`, `AuthenticationService.API/Program.cs`, `AuthenticationServiceDbContext`?**
...
- **Why does `AuthenticationService.Application.Interfaces` connect `AuthenticationService.Domain.Entities` to `IRepository`, `AuthenticationService.Application.Features.v1.Login`, `LoginHandler`, `User`, `AuthenticationService.API/Program.cs`?**
